package co.atomx.support.preference.indicator.draw.controller;
...
import co.atomx.support.preference.indicator.animation.type.AnimationType;
import co.atomx.support.preference.indicator.animation.type.BaseAnimation;
import co.atomx.support.preference.indicator.animation.type.ColorAnimation;
import co.atomx.support.preference.indicator.animation.type.FillAnimation;
import co.atomx.support.preference.indicator.animation.type.ScaleAnimation;
import co.atomx.support.preference.indicator.draw.data.Indicator;
import co.atomx.support.preference.indicator.draw.data.Orientation;
import co.atomx.support.preference.indicator.draw.data.RtlMode;
import co.atomx.support.preference.indicator.utils.DensityUtils;
